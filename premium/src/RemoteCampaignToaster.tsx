                        ...
                        <div className="relative z-10 w-full flex flex-col items-center pt-[48px]">
                            ...
                            {campaign.type === 'promo' && (
                                <motion.div 
                                    ...
                                    className="w-[380px] rounded-[20px] bg-gradient-to-b from-white/[0.04] to-transparent border border-white/[0.06] p-[24px] mb-[40px] relative overflow-hidden group"
                                >
                                    ...
                                    <div className="flex items-center justify-between mb-3 relative z-10">
                                        <div className="flex flex-col">
                                            <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-white/30">Made by Akhil</span>
                                            <span className="text-[14px] font-[900] tracking-widest text-white/90 font-mono mt-0.5">FULLY FREE</span>
                                        </div>
                                        <div className="px-2.5 py-1 rounded-full bg-white text-black text-[10px] font-black tracking-tighter">
                                            NO PAYMENT
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-end gap-3 leading-none relative z-10 mt-5">
                                        <div className="flex items-baseline gap-1.5">
                                            <span className="text-[48px] font-[700] text-white leading-none tracking-[-0.02em] text-shadow-sm">$0</span>
                                            <span className="text-[14px] font-bold text-white/40 mb-1.5">FREE</span>
                                        </div>
                                        <div className="h-[24px] w-px bg-white/10 mx-1 mb-2" />
                                        <div className="mb-2">
                                            <span className="text-[13px] font-semibold text-white/60 block leading-tight">Lifetime Access</span>
                                            <span className="text-[11px] font-medium text-white/20 line-through tracking-wide">No payment needed</span>
                                        </div>
                                    </div>
                                </motion.div>
                            )}
                            ...
                            <div className="w-full px-[48px] flex flex-col gap-4 relative">
                                ...
                                <div className="absolute left-[48px] right-[48px] h-[54px] bg-white/20 blur-xl rounded-[18px] animate-[pulse_4s_ease-in-out_infinite] scale-105" />
