                    ...
                    >
                        ...
                        <div className="w-full px-[32px] mt-6 mb-8 flex flex-col gap-3">
                            ...
                            <div className="bg-[#FACC15]/10 border border-[#FACC15]/30 rounded-[16px] rounded-tr-sm p-4 w-[90%] self-end relative shadow-[0_4px_24px_rgba(250,204,21,0.15)]">
                                ...
                                <p className="text-[13px] text-[#FACC15] font-medium leading-[1.5] mt-1">"i added new feature which it will work super awesome  with profile intelligence you  will get human like answers." <span className="text-white/60 font-normal italic">(Your actual experience)</span></p>
                            </div>
                        </div>
