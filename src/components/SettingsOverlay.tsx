                    ...
                    >
                        ...
                        <div className="w-64 bg-bg-sidebar flex flex-col border-r border-border-subtle">
                            ...
                            <div className="mt-auto p-6 border-t border-border-subtle">
                                ...
                                >
                                    <LogOut size={16} /> Quit Akhil Copilot
                                </button>
                                ...
                                <div className="space-y-6 animated fadeIn">
                                    <div className="space-y-3.5">
                                        ...
                                        <div className={`bg-bg-item-surface rounded-xl p-5 border border-border-subtle flex items-center justify-between transition-all ${isUndetectable ? 'shadow-lg shadow-blue-500/10' : ''}`}>
                                            <div className="flex flex-col gap-1">
                                                ...
                                                <p className="text-xs text-text-secondary">
                                                    AkhilCopilot is currently {isUndetectable ? 'undetectable' : 'detectable'} by screen-sharing. <button className="text-blue-400 hover:underline">Supported apps here</button>
                                                </p>
                                            </div>
                                            <div
                                                onClick={() => {
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-text-secondary mb-2">Customize how Akhil Copilot works for you</p>
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            <h3 className="text-sm font-bold text-text-primary">Open Akhil Copilot when you log in</h3>
                                                            <p className="text-xs text-text-secondary mt-0.5">Akhil Copilot will open automatically when you log in to your computer</p>
                                                        </div>
                                                    </div>
                                                    <div
                                                        onClick={() => {
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-text-secondary mt-0.5">Customize how Akhil Copilot looks on your device</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex items-start gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-text-secondary mt-0.5">
                                                                You are currently using Akhil Copilot version {packageJson.version}
                                                            </p>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="bg-bg-item-surface rounded-xl p-5 border border-border-subtle">
                                        <div className="flex flex-col gap-1 mb-3">
                                            ...
                                            <p className="text-xs text-text-secondary">
                                                Disguise Akhil Copilot as another application to prevent detection during screen sharing.
                                ...
                                <div className="space-y-5 animated fadeIn select-text pb-4">
                                    <div className="flex items-start justify-between">
                                        <div>
                                            ...
                                            <p className="text-xs text-text-secondary">Akhil Copilot works with these easy to remember commands.</p>
                                        </div>
                                        <button
