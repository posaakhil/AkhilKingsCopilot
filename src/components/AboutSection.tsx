...
import evinProfile from '../assets/evin.png'; // You'll need to add your profile image
...
export const AboutSection: React.FC<AboutSectionProps> = () => {
    ...
    return (
        <div className="space-y-6 animated fadeIn pb-10">
            {/* Header */}
            <div>
                <h3 className="text-lg font-bold text-text-primary mb-1">About Akhil Copilot</h3>
            ...
            <div>
                <h4 className="text-xs font-bold text-text-tertiary uppercase tracking-wider mb-2 px-1">How Akhil Copilot Works</h4>
                <div className="bg-bg-item-surface rounded-xl border border-border-subtle overflow-hidden">
                    <div className="p-3 border-b border-border-subtle bg-bg-card/50">
                        <div className="flex items-start gap-4">
                    ...
                    <div className="p-3 bg-bg-card/50">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary leading-relaxed">
                                    A purely local vector memory system allows Akhil Copilot to recall details from past meetings. Embeddings and retrieval happen on-device via SQLite for maximum privacy.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-text-secondary mt-1 leading-relaxed">
                                Akhil Copilot listens only when active. It does not record video, take arbitrary screenshots without command, or perform background surveillance.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h5 className="text-sm font-bold text-text-primary">GitHub Profile</h5>
                            </div>
                        </div>
                        <a
                            href="https://github.com/posaakhil"
                            onClick={(e) => handleOpenLink(e, "https://github.com/posaakhil")}
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex items-start gap-4">
                                <div className="w-12 h-12 rounded-full bg-bg-elevated border border-border-subtle flex items-center justify-center overflow-hidden shrink-0">
                                    <img src={evinProfile} alt="Posa Akhil" className="w-full h-full object-cover" />
                                </div>
                                <div className="pt-0.5">
                                    <div className="flex items-center gap-2 mb-1">
                                        <h5 className="text-sm font-bold text-text-primary">Posa Akhil</h5>
                                    ...
                                    <p className="text-xs text-text-secondary leading-relaxed max-w-lg">
                                        ...
                                        <br />
                                        <span className="font-bold text-text-primary">Akhil Copilot</span> is made to feel fast, quiet, and respectful of your privacy.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary mt-0.5">Love Akhil Copilot? Support us by starring the repo.</p>
                            </div>
                        </a>
                    ...
                    <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <a
                            href="mailto:pvakhil12@gmail.com"
                            onClick={(e) => handleOpenLink(e, "mailto:pvakhil12@gmail.com")}
                            className="whitespace-nowrap px-4 py-2 bg-text-primary hover:bg-white/90 text-bg-main text-xs font-bold rounded-lg transition-all shadow hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2"
                        >
                            <Mail size={14} />
                            Contact Me
                    ...
                    <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5 flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-text-secondary mt-0.5">Akhil Copilot is independent open-source software.</p>
                            </div>
                        </div>
                        <a
                            href="https://buymeacoffee.com/posaakhil"
                            onClick={(e) => handleOpenLink(e, "https://buymeacoffee.com/posaakhil")}
