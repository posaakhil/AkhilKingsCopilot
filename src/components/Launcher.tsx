                            ...
                            <section className="bg-bg-elevated px-8 pt-6 pb-8 border-b border-border-subtle shrink-0">
                                <div className="max-w-4xl mx-auto space-y-6">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            <h1 className="text-3xl font-celeb-light font-medium text-text-primary tracking-wide drop-shadow-sm">My Akhil Copilot</h1>
                                ...
                                "
                                        >
                                            ...
                                            <span className="drop-shadow-[0_1px_1px_rgba(0,0,0,0.1)] text-[20px] leading-none">Start Akhil Copilot</span>
                                        </button>
                                    </div>
