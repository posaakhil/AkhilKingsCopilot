...
const FEATURES: FeatureSlide[] = [
    {
        ...
        subtitle: 'Smarter answers, built for you',
        bullets: ['Code-aware AI that understands your repository','Real-time voice coaching (beta)'],
        footer: 'Designed 100%free, built by Akhil for live interviews.',
        type: 'premium',
    },

    {
        id: 'support_natively',
       headline: 'Support AkhilCopilot',
subtitle: 'Free forever, built by Akhil for the community',
bullets: [
    'AI-powered mock iterviews & real-time feedback',
    'Job description analysis & resume matching',
    'Voice-enabled assistant for practice sessions',
],

type: 'support',
actionLabel: 'Join the community',
url: 'https://github.com/posaakhil'
    }
];
